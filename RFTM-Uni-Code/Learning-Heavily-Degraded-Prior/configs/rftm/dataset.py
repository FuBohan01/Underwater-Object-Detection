...
img_prefix_urpc_train='/root/DUO/images/train'
img_prefix_urpc_test ='/root/DUO/images/test'#img_prefix_urpc_train

# ann
ann_train_dfui='/root/dfui/annotations/instances_trainval2017.json'
ann_train_urpc='/root/DUO/annotations/instances_train.json'
ann_test_urpc='/root/DUO/annotations/instances_test.json'
